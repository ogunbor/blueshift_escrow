...
// First create the MakeAccounts struct to hold all accounts needed
// Helpers were used to validate accounts (from helpers.rs)
...
// Second, create the instruction data struct to hold parsed instruction data
